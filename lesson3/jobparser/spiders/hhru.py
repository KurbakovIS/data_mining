...
class HhruSpider(scrapy.Spider):
    ...
    def parse(self, response: HtmlResponse):
        ...
        vacancy = response.css('div.vacancy-serp div.vacancy-serp-item div.vacancy-serp-item__row_header '
    ...
    def vacansy_parse(self, response: HtmlResponse):
        ...
        company = response.css('div.vacancy-company a.vacancy-company-name span::text').extract_first()
